        ...
        <section className="flex min-h-[calc(100vh-80px)] items-center justify-center px-4 py-12">
          <div className="w-full max-w-md">
            <div className="card p-8 text-center">
              ...
              <p className="mt-2 text-sm text-[var(--brand-muted)]">
                This account belongs to an <span className="font-bold">Agency</span>. Please use the Agency login instead.
              </p>
              <Link href="/login/agency" className="btn-primary mt-6 w-full block">
                Go to Agency login
              </Link>
              <button
                type="button"
