...
/* ----------------------------------------------------------------
 * Public API — analyze a single URL slug string
 * ---------------------------------------------------------------- */
...
function mergeOptions(opts: UrlAnalyzerOptions): RequiredAnalyzerOptions {
  return {
    ...
    requireCity: opts.requireCity ?? defaults.requireCity,
    requireLocality: opts.requireLocality ?? defaults.requireLocality,
    requirePropertyType: opts.requirePropertyType ?? defaults.requirePropertyType,
    allowedSpecialChars: opts.allowedSpecialChars ?? defaults.allowedSpecialChars,
  };
}
